...
export default function LoginPage() {
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<div className="grid lg:grid-cols-2 min-h-[calc(100vh-89px)]">
				{/* Left side - Features */}
				<div className="hidden lg:flex flex-col justify-center px-12 xl:px-16 bg-slate-50">
					<div className="max-w-md">
						...
						<div className="space-y-4">
							<div className="flex items-center gap-3">
								...
								<span className="text-slate-700">Project management with Kanban boards</span>
							</div>
							<div className="flex items-center gap-3">
								<div className="p-2 bg-blue-100 rounded-lg">
									<Zap className="h-5 w-5 text-blue-600" />
								</div>
								<span className="text-slate-700">Time tracking and automated invoicing</span>
							</div>
							<div className="flex items-center gap-3">
								<div className="p-2 bg-purple-100 rounded-lg">
									<Users className="h-5 w-5 text-purple-600" />
								</div>
								<span className="text-slate-700">Client portals and public profiles</span>
							</div>
							<div className="flex items-center gap-3">
								<div className="p-2 bg-orange-100 rounded-lg">
									<Shield className="h-5 w-5 text-orange-600" />
								</div>
								<span className="text-slate-700">Secure and professional experience</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="flex flex-col justify-center px-6 lg:px-12 xl:px-16 py-12">
					<div className="max-w-md mx-auto w-full">
						<div className="text-center mb-8">
							<h2 className="text-3xl font-semibold text-slate-900 mb-2">{heading}</h2>
							<p className="text-slate-600">{sub}</p>
						</div>

						{/* Tab switcher */}
						<div className="flex gap-1 rounded-lg bg-slate-100 p-1 mb-8">
							<button
								type="button"
